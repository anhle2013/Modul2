package automatic_testing.next_day;
...
public class TestDay {
    ...
    void nextDay1And1And2018() {
        ...
        String result = NextDay.nextDayCalculator(1, 1, 2018);
    ...
    void nextDay31And1And2018() {
        ...
        String result = NextDay.nextDayCalculator(31, 1, 2018);
        Assertions.assertEquals(expected, result);
    }
    @Test
    ...
    void nextDay30And4And2018() {
        ...
        String result = NextDay.nextDayCalculator(30, 4, 2018);
        Assertions.assertEquals(expected, result);
    }
    @Test
    ...
    void nextDay28And2And2018() {
        ...
        String result = NextDay.nextDayCalculator(28, 2, 2018);
        Assertions.assertEquals(expected, result);
    }
    @Test
    ...
    void nextDay2And1And2018() {
        ...
        String result = NextDay.nextDayCalculator(2, 1, 2018);
        Assertions.assertEquals(expected, result);
    }
    @Test
    ...
    void nextDay1And2And2018() {
        ...
        String result = NextDay.nextDayCalculator(1, 2, 2018);
        Assertions.assertEquals(expected, result);
    }
    @Test
    ...
    void nextDay1And5And2018() {
        ...
        String result = NextDay.nextDayCalculator(1, 5, 2018);
        Assertions.assertEquals(expected, result);
    }
    @Test
